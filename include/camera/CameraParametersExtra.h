...
const char QCameraParameters::KEY_MOT_AUTO_DC_OFFSET[] = "auto-dc-offset-mode"; \
const char QCameraParameters::KEY_MOT_DENOISE[] = "mot-denoise-features"; \
const char QCameraParameters::KEY_MOT_LUMA_ADAPTATION[] = "luma_adaptation"; \
const char QCameraParameters::KEY_MOT_MANUAL_DC_OFFSET[] = "manual-dc-offset"; \
const char QCameraParameters::KEY_MOT_TINTLESS[] = "tintless"; \
const char QCameraParameters::KEY_MOT_SUPPORTED_AUTO_DC_OFFSET[] = "auto-dc-offset-mode-values"; \
const char QCameraParameters::KEY_MOT_SUPPORTED_DENOISE[] = "mot-denoise-features-values"; \
const char QCameraParameters::KEY_MOT_SUPPORTED_LUMA_ADAPTATION[] = "luma_adaptation-values"; \
const char QCameraParameters::KEY_MOT_SUPPORTED_TINTLESS[] = "tintless-values"; \
