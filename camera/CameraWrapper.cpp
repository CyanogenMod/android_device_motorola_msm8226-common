...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    if (!(get_product_device() == FALCON || get_product_device() == PEREGRINE) ||
        ...
        params.set(CameraParameters::KEY_SUPPORTED_SCENE_MODES,
                "auto,hdr,auto_hdr,action,portrait,landscape,night,night-portrait,"
                "theatre,backlight,beach,snow,sunset,steadyphoto,fireworks,sports,"
                "party,candlelight,flowers,AR");
    }
